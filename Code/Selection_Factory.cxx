...
#include "cherepanov/Skimmer.h"
#include "cherepanov/BasicSelection.h"
#include "cherepanov/WJetCorrectionFactor.h"
#include "cherepanov/BackgroundEstimator.h"
#endif
#ifdef USE_inugent
...
#ifdef USE_cherepanov
  else if(Analysis.Contains("basicselection"))s=new BasicSelection(Analysis,UncertType);
  else if(Analysis.Contains("wjetcorrectionfactor"))s=new WJetCorrectionFactor(Analysis,UncertType);
  else if(Analysis.Contains("backgroundestimator"))s=new BackgroundEstimator(Analysis,UncertType);
#endif
#ifdef USE_inugent
