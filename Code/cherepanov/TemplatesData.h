#ifndef TemplatesData_h
#define TemplatesData_h
...
class TemplatesData : public Selection {
 
 public:
  TemplatesData(TString Name_, TString id_); 
  virtual ~TemplatesData();
...
/*       std::vector<TH1D> TauA1VisiblePtHPSPFTauDiscriminationByTightIsolationMVA2;  */
     ...
     std::vector<TH1D> RecOmegaA1p;
     std::vector<TH1D> RecOmegaA1m;
     std::vector<TH1D> RecOmegaA1z;

     
     std::vector<TH1D> RecOmegaMup;
     std::vector<TH1D> RecOmegaMum;
     std::vector<TH1D> RecOmegaMuz;

     std::vector<TH1D> RecOmegaCombinedp;
     std::vector<TH1D> RecOmegaCombinedm;
     std::vector<TH1D> RecOmegaCombinedz;

     
     std::vector<TH2D> RecoCosTheta_CosBeta_ZFrame_Plus;
     std::vector<TH2D> RecoCosTheta_CosBeta_ZFrame_Minus;
     std::vector<TH2D> RecoCosTheta_CosBeta_ZFrame_Zero;
