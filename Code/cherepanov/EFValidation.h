...
class EFValidation : public Selection {
 ...
 private:
  ...
  std::vector<TH1D> TauA1PMinusPull;
  std::vector<TH1D> TauA1PPlusPull;
  std::vector<TH1D> TauA1PAmbigaPull;

  std::vector<TH1D> TauA1PMinusPPropagatorPull;
  std::vector<TH1D> TauA1PPlusPPropagatorPull;
/*   std::vector<TH1D> TauA1PMinusPull; */
/*   std::vector<TH1D> TauA1PPlusPull; */


  std::vector<TH1D> A1PxPull;
  std::vector<TH1D> A1PyPull;
  std::vector<TH1D> A1PzPull;
  std::vector<TH1D> A1PPull;
  std::vector<TH1D> TestPropagation;
  ...
  std::vector<TH1D> PVxPull;
  std::vector<TH1D> PVyPull;
  std::vector<TH1D> PVzPull;


  std::vector<TH1D> GJReco;
  std::vector<TH1D> dGJReco;
  std::vector<TH1D> GJRecoZoom;
  std::vector<TH1D> GJTruth;


  std::vector<TH1D> GJResol;
  std::vector<TH1D> GJPull;
  std::vector<TH1D> GJPull2;


  std::vector<TH1D> pullpx1px2;

  std::vector<TH1D> pullpx1;
  std::vector<TH1D> pullpx2;

  std::vector<TH1D> pullsvxaddpvx;
  std::vector<TH1D> pullsvxpvx;


  std::vector<TH1D> pulltaudirx;
  std::vector<TH1D> pulltaudiry;
  std::vector<TH1D> pulltaudirz;

  std::vector<TH1D> NormedXpulltaudir;
  std::vector<TH1D> NormedYpulltaudir;
  std::vector<TH1D> NormedZpulltaudir;

  std::vector<TH1D> pulltaudirmag;



  std::vector<TH1D> pullscalarproductz;
